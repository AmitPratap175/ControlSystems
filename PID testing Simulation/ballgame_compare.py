...
class BallGame:
    def __init__(self):
        ...
        self.cross_hair_obj2_x = pygame.draw.line(self.screen, self.green, \
                                            self.cross_hair_x1,\
                                            self.cross_hair_x2, 2)
        self.cross_hair_obj2_y = pygame.draw.line(self.screen, self.green, \
                                            self.cross_hair_y1,\
                                            self.cross_hair_y2, 2)
    ...
    def main(self):
        ...
        self.crosshair2_speed[0],self.crosshair2_speed[1],self.crosshair_speed[0],self.crosshair_speed[1] =self.gimbal.update(self.dt, (delta_x,delta_y))
        ...
        self.cross_hair_obj2_x = self.cross_hair_obj_x.move(self.crosshair2_speed)
        self.cross_hair_obj2_y = self.cross_hair_obj_y.move(self.crosshair2_speed)
        ...
        pygame.draw.line(self.screen, self.white, (self.cross_hair_obj2_x.centerx,self.cross_hair_obj2_x.centery - self.crosshair_size),\
                                                  (self.cross_hair_obj2_x.centerx,self.cross_hair_obj2_x.centery + self.crosshair_size), 2)
        pygame.draw.line(self.screen, self.white, (self.cross_hair_obj2_y.centerx - self.crosshair_size, self.cross_hair_obj2_y.centery),\
                                                  (self.cross_hair_obj2_y.centerx + self.crosshair_size, self.cross_hair_obj2_y.centery), 2)
...
class GimbalControl:
    ...
    def speed_conversion(self):
        return np.ceil((self.pan - 1500) / SPEEDCONVERSION), np.ceil((self.tilt - 1500) / SPEEDCONVERSION),\
              np.ceil((self.pan_PID - 1500) / SPEEDCONVERSION), np.ceil((self.tilt_PID - 1500) / SPEEDCONVERSION)
